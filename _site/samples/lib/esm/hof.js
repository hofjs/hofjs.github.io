...
export class HofHtmlElement extends HTMLElement {
    ...
    render() {
        ...
        console.dir(this._allBindVariables);
    }
...
export function item(htmlRenderFunc) { return htmlRenderFunc; }
// render function for list html expressions
export function list(list, htmlRenderFunc, parentElement = "div", renderParentElementOnEmptyList = false) {
...
export const html = (strings, ...exprs) => processTemplate(strings, exprs);
// html template literal, that does not change expression but enables syntax highlighting
export const css = (strings, ...exprs) => processTemplate(strings, exprs);
